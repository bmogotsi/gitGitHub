...
try:
    ...
    save_epl="Standings_EPL_bs4_by_id_EG_Tag_Multi.txt"
    ...
    old_id = "#results2024-202591_overall *:contains('Premier League Table')"
    new_id=old_id.rstrip(":contains('Premier League Table')").rstrip(" *")   
    standing_table = soup.select(new_id)
    # 
    if standing_table != []:
